<x-guest-layout>
    <div class="glass-panel p-8 max-w-md w-full mx-auto" style="border-radius: 24px;">
        <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-titanium-950 tracking-tight">Login</h2>
            <p class="text-titanium-500 mt-2 text-sm">Masuk ke Layanan Pengaduan Masyarakat</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <input id="username" class="input-field" type="text" name="username" value="{{ old('username') }}" required autofocus autocomplete="username" />
            ...
            <div class="mt-6" x-data="{ showPassword: false }">
                ...
                <div class="relative">
                    <input id="password" class="input-field w-full pr-10" :type="showPassword ? 'text' : 'password'" name="password" required autocomplete="current-password" />
            ...
            <div class="flex items-center justify-between mt-8">
                <span class="text-sm text-titanium-500">
                    Belum punya akun? <a href="{{ route('register') }}" class="text-titanium-900 font-medium hover:underline">Daftar</a>
                </span>
